// src/components/SimpleResetPassword.js
import React, { useState, useEffect } from 'react';
import { apiService } from '../services/apiService';
import PasswordStrengthIndicator from './PasswordStrengthIndicator';
import './ResetPassword.css';

function SimpleResetPassword({ onBackToLogin }) {
    ...
    const [verificandoToken, setVerificandoToken] = useState(false);

    useEffect(() => {
        // Pega o token da URL usando método simples
            ...
            if (resultado.success) {
                ...
                setTimeout(() => {
                    if (onBackToLogin) {
                        ...
                        // Fallback: recarrega a página na raiz
